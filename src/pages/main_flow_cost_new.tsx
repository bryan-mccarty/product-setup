...
export default function OutcomePrioritizationMajor() {
  ...
  const [options, setOptions] = useState([
    { id: "optionA", name: "Option A", cost: 5.32, sweetness: 7, sourness: 3 },
    { id: "optionB", name: "Option B", cost: 3.31, sweetness: 6, sourness: 5 },
    { id: "optionC", name: "Option C", cost: 4.56, sweetness: 8, sourness: 2 }
  ]);
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <p className="text-lg font-semibold text-center mt-8">
        Now, help Luna understand what tradeoffs you're willing to make to lower cost.
      </p>
          ...
          <div className="w-64 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div className="divide-y divide-gray-200">
              <div className="flex justify-between px-4 py-2">
                ...
                <span className="text-sm">{GOAL_VALUES.cost}</span>
              </div>
              <div className="flex justify-between px-4 py-2">
