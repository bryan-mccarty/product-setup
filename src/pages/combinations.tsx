...
const CombinationsModal = ({ onClose, onSave }) => {
  ...
  // Simulated continuous inputs (in real app, would come from props/context)
  const availableInputs = [
    { id: 'input-1', name: 'Flour', inputType: 'Ingredient', cost: 0.42 },
    { id: 'input-2', name: 'Sugar', inputType: 'Ingredient', cost: 0.68 },
    { id: 'input-3', name: 'Butter', inputType: 'Ingredient', cost: 1.85 },
    { id: 'input-4', name: 'Eggs', inputType: 'Ingredient', cost: 0.35 },
    { id: 'input-5', name: 'Vanilla Extract', inputType: 'Ingredient', cost: 4.20 },
    { id: 'input-6', name: 'Cocoa Powder', inputType: 'Ingredient', cost: 2.15 },
    { id: 'input-7', name: 'Milk', inputType: 'Ingredient', cost: 0.52 },
    { id: 'input-8', name: 'Salt', inputType: 'Ingredient', cost: 0.15 },
    { id: 'input-9', name: 'Baking Temperature', inputType: 'Processing', cost: null },
    { id: 'input-10', name: 'Mixing Duration', inputType: 'Processing', cost: null },
    { id: 'input-11', name: 'Bake Time', inputType: 'Processing', cost: null },
    { id: 'input-12', name: 'Proofing Time', inputType: 'Processing', cost: null },
  ];
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button 
              onClick={() => {
                if (combinations.length > 0 && onSave) {
                  onSave(combinations);
                }
              }}
