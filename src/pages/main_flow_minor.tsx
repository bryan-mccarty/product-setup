...
export default function OutcomePrioritizationMinor() {
  // Options currently in rank order (index = rank‑1)
  const [options, setOptions] = useState([
    { id: 'optionA', name: 'Option A', thickness: '3', sweetness: 7, cardboard: 4 },
    { id: 'optionC', name: 'Option C', thickness: '5', sweetness: 6, cardboard: 5 },
    { id: 'optionB', name: 'Option B', thickness: '7',  sweetness: 8, cardboard: 6 }
  ]);
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="mt-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div className="bg-black h-2 rounded-full transition-all duration-300 ease-out" style={{ width: '75%' }} />
        </div>
      </div>

      {/* Subheading */}
      <p className="text-lg font-semibold text-center mt-8">
        Finally, teach Luna the importance of your minor outcomes.
      </p>
